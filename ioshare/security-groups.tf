...
# Allow Ioshare EC2 instances to access RDS PostgreSQL (port 5432)
...
# Allow Ioshare EC2 instances to access ElastiCache Redis/Valkey (port 6379)
...
# Allow Ioshare EC2 instances to access ElastiCache Memcached (port 11211)
