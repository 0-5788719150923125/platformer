#!/bin/bash
# Create Kubernetes secrets for Ioshare EKS deployments
...
# PGBOUNCER_CONFIG format matches Ioshare requirements
...
# Based on ioshare-v3storage CI configuration (storagetestS3Postgres)
