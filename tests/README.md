...
**integration.tftest.hcl**  -  Cross-module interaction tests (networking, compute, applications, config management, iorchestrator). Uses test-specific state fragments from `tests/states/`.
